      ...
      <div>
        ...
        <div style={{ marginBottom: '1rem' }}>
          {localNotes.length === 0 ? (
            <p
              className="font-sans"
              style={{ fontSize: '0.8125rem', color: 'var(--ink-3)', fontStyle: 'italic', padding: '0.5rem 0', margin: 0 }}
            >
              No notes yet.
            </p>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {localNotes.map((note, i) => (
                ...
                >
                  ...
                  <p
                    className="font-sans"
                    style={{ margin: 0, fontSize: '0.8125rem', color: 'var(--ink)', lineHeight: 1.5 }}
                  >
                    {note.note}
                  </p>
                </div>
        ...
        {/* Add note — clearly separated container */}
        <div
          style={{
            padding: '0.875rem',
        ...
        >
          <p
            className="font-sans font-semibold"
            style={{ fontSize: '0.75rem', color: 'var(--ink)', margin: '0 0 0.5rem' }}
          >
            Add a note
          </p>
          <textarea
            ...
            rows={3}
            placeholder="Add an internal note visible only to SETU staff…"
            style={{
              width: '100%',
          ...
          />
          {noteError && (
            <p className="font-sans" style={{ fontSize: '0.8125rem', color: 'var(--accent)', margin: '0 0 0.5rem' }}>
              {noteError}
            </p>
          )}
          <button
            ...
            style={{
              ...
              border: 'none',
              borderRadius: 'var(--radius-sm)',
              cursor: newNote.trim() && !isPending ? 'pointer' : 'not-allowed',
            }}
          >
            Save note
          </button>
